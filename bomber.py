...
import colorama
"""
yapacağınız herhangi bir işlemden ben sorumlu değilim. göz önüne alarak kullanın. ben sadece programı yapıp size sunuyorum
"""

colors=['\033[1;31m','\033[1;32m','\033[1;33m','\033[1;34m','\033[1;35m','\033[1;36m']

_phone = input('lütfen +90 veya hangi ulke ise o ulkenın alan kodunu girerek numarayı yazınız (+90):')
_name = ''
